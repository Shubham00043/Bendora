...
const learningGoalsData = {
  ...
  "Tech Creators Community": [
    ...
    },
    {
      ...
      description: "Learn from expert experience creating tech content",
    },
  ],
...
const freeUserAssignments = {
  ...
  "Free User Two": {
    community: "Tech Creators Community",
...
async function comprehensiveSeed() {
  ...
  try {
    ...
    const matchPairs = [
      ...
      ["Admin User", "Tech Enthusiast", "Tech Creators Community"],
    ...
    console.log("   • tech.enthusiast@email.com");
    console.log("\n💡 OTHER TEST ACCOUNTS:");
    ...
    console.log("   • Tech Creators Community");
